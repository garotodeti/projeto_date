...
def main(page: ft.Page):
    ...
    def close_page(e):
        ...
        dlg_yes.open = True
        page.update()
    dlg_yes = ft.AlertDialog(
        title=ft.Text("escreva algo ♥"),
        content=ft.Text("Escreva algo"),
        actions=[
            ft.TextButton("X", on_click=close_dlg),
        ],
    ...
    def open_dlg_modal(e):
        ...
        page.update()
    dlg = ft.AlertDialog(
        content=ft.Text("Diga sim por favor vai skaksk")
    )
    ...
    dlg_modal = ft.AlertDialog(
        ...
        actions=[
            ft.TextButton("Sim", on_click=close_page),
